...
export default function TodayOrdersInsight() {
  ...
  const items = useMemo(
    () => [
      { id: "O-25021", shop: "메리플라워", title: "축하3단", amount: 45000, date: "2025-12-20" },
      { id: "O-25022", shop: "봄꽃화원", title: "근조3단", amount: 70000, date: "2025-12-21" },
      { id: "O-25023", shop: "루비플라워", title: "꽃바구니", amount: 60000, date: "2025-12-22" },
    ],
    []
  );
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">발주 건수</h1>
      <p className="text-sm text-gray-500 mb-6">선택한 기간 기준 발주된 주문 목록과 요약입니다.</p>
