...
export default function MemberSearchModal({ open, onClose, onSelectMember }: MemberSearchModalProps) {
  ...
  const sampleMembers: Member[] = [
    { id: "m1", name: "채플꽃화", memo: "장례/플로팅", tags: ["신규회원", "야간배송"], prices: { 축하: 38, 근조: 38, 동양: 70, 서양: 70, 꽃: 70, 관엽: 80 }, phone: "02-123-4567" },
    { id: "m2", name: "앨로플라워", memo: "", tags: ["프리미엄"], prices: { 축하: 38 }, phone: "02-234-5678" },
  ];
                  ...
                  !selectedSido ? (
                    ...
                    <div>
                      ...
                      <div className="border rounded-lg overflow-hidden bg-white shadow-sm">
                        <div className="w-full h-[40vh] max-h-[320px]">
                          <InteractiveSvgMap
                            svgPath={SIDO_SVG_MAP[selectedSido] || SIDO_SVG_MAP["서울특별시"]}
              ...
              <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div className="text-sm text-gray-700">
                  {selectedSido && selectedSigungu ? (
                    <span>
                      지역: <span className="font-semibold text-gray-900">{selectedSido} {selectedSigungu}</span>
                    </span>
                  ) : (
                ...
                <MemberList
                  ...
                  onSelect={(m) => {
                    const shop: ShopItem = {
                      ...
                      region: `${selectedSido ?? ""} ${selectedSigungu ?? ""}`.trim(),
